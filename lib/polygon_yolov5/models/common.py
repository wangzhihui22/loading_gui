...
class Detections:
    ...
    def pandas(self):
        ...
        ca = 'xmin', 'ymin', 'xmax', 'ymax', 'confidence', 'class', 'y_name'  # xyxy columns
        cb = 'xcenter', 'ycenter', 'width', 'height', 'confidence', 'class', 'y_name'  # xywh columns
...
class Polygon_Detections:
    ...
    def pandas(self):
        ...
        new = copy(self)  # return copy
        ca = 'x1', 'y1', 'x2', 'y2', 'x3', 'y3', 'x4', 'y4', 'confidence', 'class', 'y_name'  # xyxyxyxy columns
